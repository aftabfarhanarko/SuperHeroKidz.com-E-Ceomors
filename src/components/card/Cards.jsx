...
const Cards = ({ one }) => {
  const { title, bangla, image, price, percentage, ratings, sold, reviews } =
    one;
    ...
    <div className="group relative max-w-sm bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 ease-out border border-gray-100">
      ...
      <div className="p-3">
        ...
        <div className="flex gap-3">
          <button
            className="flex-1 bg-gradient-to-r justify-center  from-primary flex items-center gap-4 to-pink-600 text-white 
          py-3 rounded-xl font-semibold shadow-md hover:shadow-lg hover:from-rose-600 hover:to-pink-700 transition-all duration-300 transform hover:-translate-y-0.5"
          >
